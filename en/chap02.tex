...
However, such an approach would only fully work in the case of only internal - or only external authors.
...
\footnotetext{Both methods have been reevaluated on a smaller representative subset of data ($n = 500$). For this reason, the naïve approach performance slightly differs from the previous evaluation.}
